...
pygame.display.set_caption("Sorting Master - Color Swapped")
...
class Garbage:
    def __init__(self):
        ...
        elif self.type == "RECYCLE": self.color = YELLOW  # เดิม BLUE สลับเป็น YELLOW
        elif self.type == "GENERAL": self.color = BLUE    # เดิม YELLOW สลับเป็น BLUE
...
# --- 3. ข้อมูลถังขยะ (สลับสีให้ตรงกับขยะ) ---
bins = [
    {"type": "RECYCLE", "rect": pygame.Rect(40, 440, 160, 120), "color": YELLOW, "label": "RECYCLE"}, # สลับเป็น YELLOW
    {"type": "WET", "rect": pygame.Rect(230, 440, 160, 120), "color": GREEN, "label": "WET"},
    {"type": "GENERAL", "rect": pygame.Rect(420, 440, 160, 120), "color": BLUE, "label": "GENERAL"},   # สลับเป็น BLUE
